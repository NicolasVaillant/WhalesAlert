...
with open("./resources/config_python/kylacoin/tweet.json", "r") as f:
...
def get_transaction_info():
    ...
    supply_url: str = "https://api.kcnxp.com/supply"
    try:
        ...
        url: str = "https://api.kcnxp.com/blocks?offset=0&limit=10"
        url_block : str = "https://api.kcnxp.com/txs?block="
        url_tx: str = "https://kcnxp.com/block/"
...
def post_tweet(payload: dict) -> None:
    ...
    with open("./resources/config_python/kylacoin/config.json") as f:
...
def job_kylacoin() -> None:
    global tweets_this_day, day
    logger_fonction_tx_analyze.info("Job Kylacoin")

    with open("./resources/config_python/kylacoin/tweet.json", "r") as f:
        globals_data = json.load(f)

    # Récupérez le prix DNX
    price: float = get_kylacoin_price()
    ...
    for transaction in transactions:
        ...
        message = "🐋 Whale Alert! 🚨\n"
        message += f"A transaction of {total_out_str} $KCN "
    ...
    with open("./resources/config_python/kylacoin/tweet.json", "w") as f:
