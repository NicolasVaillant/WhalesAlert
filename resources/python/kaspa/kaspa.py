...
# Version pc
tweet_json = Path("resources", "config_python", "kaspa", "tweet.json")
config_json = Path("resources", "config_python", "kaspa", "config.json")
telegram_json = Path("resources", "config_python", "telegram.json")
tx_data_json = Path("resources", "data_tx", "tx_kaspa.json")

# Version serveur
# tweet_json = Path("/home", "container", "webroot","resources", "config_python", "kaspa", "tweet.json")
# config_json = Path("/home", "container", "webroot","resources", "config_python", "kaspa", "config.json")
# telegram_json = Path("/home", "container", "webroot","resources", "config_python", "telegram.json")
# tx_data_json = Path("/home", "container", "webroot","resources", "data_tx", "tx_kaspa.json")
...
def get_kaspa_price() -> float:
    with open(tweet_json, "r") as f:
        globals_data = json.load(f)
    f.close()
    return globals_data['price']

def put_kaspa_price(price) -> float:
        ...
        if data.get('type') == 'block':
            ...
            for tx in transactions:
                ...
                if amount > 25000: 
                    ...
                    url_tx_hash = "https://explorer.kaspa.network/block/" + block_data.get('hash', {})
